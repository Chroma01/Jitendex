...
public sealed class OverlaidSequence : Sequence, ISequence
{
    internal const char Indicator = '⿻';
    static string ISequence.GetIndicator() => Indicator.ToString();
    static int ISequence.ArgumentCount() => 2;
    static string ISequence.FirstPositionName() => "Overlaying";
    static string ISequence.SecondPositionName() => "Overlaid";
