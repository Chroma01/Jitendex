...
public sealed class SurroundFromBelowSequence : Sequence, ISequence
{
    internal const char Indicator = '⿶';
    static string ISequence.GetIndicator() => Indicator.ToString();
    static int ISequence.ArgumentCount() => 2;
    static string ISequence.FirstPositionName() => "BelowSurrounding";
    static string ISequence.SecondPositionName() => "AboveSurrounded";
