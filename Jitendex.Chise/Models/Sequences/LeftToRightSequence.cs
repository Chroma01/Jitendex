...
public sealed class LeftToRightSequence : Sequence, ISequence
{
    internal const char Indicator = '⿰';
    static string ISequence.GetIndicator() => Indicator.ToString();
    static int ISequence.ArgumentCount() => 2;
    static string ISequence.FirstPositionName() => "LeftHalf";
    static string ISequence.SecondPositionName() => "RightHalf";
