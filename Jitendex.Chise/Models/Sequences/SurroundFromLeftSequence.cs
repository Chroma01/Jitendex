...
public sealed class SurroundFromLeftSequence : Sequence, ISequence
{
    internal const char Indicator = '⿷';
    static string ISequence.GetIndicator() => Indicator.ToString();
    static int ISequence.ArgumentCount() => 2;
    static string ISequence.FirstPositionName() => "LeftSurrounding";
    static string ISequence.SecondPositionName() => "RightSurrounded";
