...
internal sealed class QueryCodeTable : Table<QueryCode>
{
    ...
    [
        ...
        new("@1", queryCode.Order),
        new("@2", queryCode.Text),
        new("@3", queryCode.TypeName),
        new("@4", queryCode.Misclassification.Nullable()),
    ];
}
