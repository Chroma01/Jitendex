...
internal static class JapaneseSentenceData
{
    // Column names
    private const string C1 = nameof(JapaneseSentence.Id);
    private const string C2 = nameof(JapaneseSentence.Text);
    ...
    private const string InsertSql =
        $"""
        INSERT INTO "{nameof(JapaneseSentence)}"
        ("{C1}", "{C2}") VALUES
        ( {P1} ,  {P2} );
        """;
