...
[PrimaryKey(nameof(JapaneseSentenceId), nameof(EnglishSentenceId))]
public class Example
{
    public required int JapaneseSentenceId { get; set; }
    public required int EnglishSentenceId { get; set; }

    [ForeignKey(nameof(JapaneseSentenceId))]
    public required JapaneseSentence JapaneseSentence { get; set; }
