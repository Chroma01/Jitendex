...
internal sealed class KanjiFormRestrictionTable : Table<KanjiFormRestriction>
{
    ...
    protected override SqliteParameter[] Parameters(KanjiFormRestriction restriction) =>
    [
